...
- Attach the latest bundle analyzer folder, k6 JSON, and `docs/perf-proof.md` to PRs covering Steps 13–15. CI enforces analyzer generation and uploads artifacts automatically via GitHub workflows; local runs can be verified via `scripts/full-validation.sh` after installing `k6`.
